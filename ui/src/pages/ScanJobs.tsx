...
export default function ScanJobs() {
  ...
  useEffect(() => {
    fetch('/api/scan').then(r => {
      if (r.status === 405) setHasServerKey(true) // API exists
    }).catch(() => {})
  }, [])
    ...
    <div className="view-wrap" style={{ padding: '36px 40px', maxWidth: 860 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 13.5, color: 'var(--text-muted)', margin: 0 }}>
          Scans UAE job boards for your target roles with AI-powered matching.
        </p>
      </div>
      ...
      <div className="card" style={{ padding: 22, marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 12.5, color: 'var(--text-muted)', margin: '0 0 14px', lineHeight: 1.5 }}>
          Searches Indeed UAE, Gulftalent, and Naukri Gulf for Data Analyst, IT Specialist, BI Analyst roles.
          {hasServerKey ? ' Results scored by DeepSeek AI.' : ''}
        </p>
